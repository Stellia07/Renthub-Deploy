      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('all.type') }}" class="nav-link">All Property Types</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#emails" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
              <span class="link-title">Property District</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('all.district') }}" class="nav-link">All Property District</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('add.district') }}" class="nav-link">Add Property District</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="amenity">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('all.amenity') }}" class="nav-link">All Amenities</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button" aria-expanded="false" aria-controls="uiComponents">
              ...
              <span class="link-title">Manage Owner</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('all.owner') }}" class="nav-link">All Owner</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('add.owner') }}" class="nav-link">Add Owner</a>
                </li>
              </ul>
            </div>
          </li>
