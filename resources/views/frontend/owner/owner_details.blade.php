...
<figure class="image-box"><img src="{{ (!empty($owner->photo)) ? url('upload/owner_images/'.$owner->photo) : url('upload/no_image.jpg') }}" alt="" style="width:270px; height:330px;" ></figure>
<div class="content-box">
<div class="upper clearfix">
    <div class="title-inner pull-left">
        <h4>{{ $owner->name }}</h4>
        <span class="designation">{{ $owner->username }}</span>
    </div>
...
<ul class="info clearfix mr-0">
    <li><i class="fab fa fa-envelope"></i><a href="mailto:bean@realshed.com">{{ $owner->email }}</a></li>
    <li><i class="fab fa fa-phone"></i>
    	<a href="tel:03030571965">{{ $owner->phone }}</a></li>
</ul>
</div>
</div>
</div>
                ...
                <div class="inner-box">
                    <div class="image-box">
                       ...
                       @endif
                        ...
                        <div class="buy-btn"><a href="property-details.html">For Rent</a></div>
                    </div>
...
<div class="form-inner">
    ...
    @endphp
     ...
     <form action="{{ route('owner.details.message') }}" method="post" class="default-form">
        @csrf  
