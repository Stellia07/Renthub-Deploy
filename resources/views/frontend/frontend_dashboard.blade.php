...
<!-- Fav Icon -->
<link rel="icon" href="{{ asset('frontend/assets/images/RenthubIcon.png') }}" type="image/x-icon">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <div class="price-box clearfix">
                                            <div class="price-info pull-left">
                                                <h6>Rent Price</h6>
                                                <h4>$${value.property.rent_price}</h4>
                                            </div>
    ...
    <script type="text/javascript">
      ...
      rows += ` <tr>
                    ...
                    <th>
                        ...
                        <div class="price">₱${value.property.rent_price}</div>
                    </th>
