        ...
        <div class="top-inner clearfix">
            ...
            <div class="right-column pull-right">
                ...
                @auth
                    ...
                    <div class="sign-box">
                        <a href="{{ route('user.profile') }}"><i class="fas fa-user"></i>Dashboard</a>
                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <!-- <li><a href="{{ url('/') }}"><span>Owner </span></a> </li>
                                ...
                                <li> 
                                    <a href="{{ route('user.logout.owner.login') }}" class="btn btn-warning" id="addlisting"><span>+</span>Add Listing</a>
                                </li>
                                @else
                                <li> 
                                    <a href="{{ route('owner.login') }}" class="btn btn-warning" id="addlisting"><span>+</span>Add Listing</a>
                                </li>
