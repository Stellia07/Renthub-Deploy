                        ...
                        <div class="default-sidebar property-sidebar">
                            <div class="filter-widget sidebar-widget">
                                ...
                                @php
                                    ...
                                    $furnishing = App\Models\Property::distinct('furnish_status')->pluck('furnish_status');
                                ...
                                <div class="widget-content">
                                    <div class="select-box">
                                        <select class="wide" name="ptype_id">
                                           ...
                                           <option data-display="All Type" selected disabled>All Type</option>
                                    ...
                                    <div class="select-box">
                                        <select class="wide" name="furnishing">
                                            <option data-display="Furnish Status" selected disabled>Select Furnish Status</option>
                                            @foreach($furnishing as $furnish_status)
                                            <option value="{{ $furnish_status }}">{{ $furnish_status }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="select-box">
                                        <select class="wide" name="barangay">
                                            <option data-display="Select District/Municipality" selected disabled>District/Municipality</option>
                                            @php
                                                $sortedBarangays = $barangays->sort();
                                            @endphp
                                            @foreach($sortedBarangays as $barangay)
                                    ...
                                    <div class="select-box">
                                        <select class="wide" name="bedrooms">
                                           <option data-display="Bedrooms" selected disabled>Bedrooms</option>
                                    ...
                                    <div class="select-box">
                                        <select class="wide" name="bathrooms">
                                           <option data-display="Bathrooms" selected disabled>Bathrooms</option>
                            ...
                            <div class="category-widget sidebar-widget">
                                ...
                                <ul class="category-list clearfix">
                                    <li><a href="{{ route('rent.property') }}">For Rent <span>({{ count($property) }})</span></a></li>
...
<div class="author-box pull-right">
  ...
  @else 
   ...
   <div class="author-box pull-right">
        <figure class="author-thumb"> 
            <img src="{{ (!empty($item->user->photo)) ? url('upload/owner_images/'.$item->user->photo) : url('upload/no_image.jpg') }}" alt="">
