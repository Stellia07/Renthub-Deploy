                    ...
                    <div class="author-box pull-left">
                        ...
                        @else
                            <figure class="author-thumb"><img
                                    src="{{ !empty($property->user->photo) ? url('upload/owner_images/' . $property->user->photo) : url('upload/no_image.jpg') }}"
                                    alt=""></figure>
            ...
            <div class="right-column pull-right clearfix">
                <div class="price-inner clearfix">
                    <ul class="category clearfix pull-left">
                        ...
                        <li><a href="property-details.html">For Rent</a></li>
                    </ul>
                    <div class="price-box pull-right">
                        <h3>₱ {{ $property->rent_price }}</h3>
                    </div>
                </div>
                ...
                <div class="property-details-content">
                    ...
                    <div class="details-box content-widget">
                        ...
                        <ul class="list clearfix">
                            ...
                            <li>Property Price: <span>₱ {{ $property->rent_price }}</span></li>
                            <li>Property Type: <span>{{ $property->type->type_name }}</span></li>
                            <li>Bathrooms: <span>{{ $property->bathrooms }}</span></li>
                            <li>Furnishing: <span>{{ $property->furnish_status }}</span></li>
                    ...
                    <div class="location-box content-widget">
                        ...
                        <ul class="info clearfix">
                            <li><span>Full Address:</span> {{ $property->address }}</li>
                            <li><span>District/Municipality:</span> {{ $property->barangay }}</li>
                            <li><span>City:</span> {{ $property->city }}</li>
                            <li><span>Province:</span> {{ $property->province }}</li>
                        ...
                        <div class="google-map-area">
                            <div class="google-map" id="contact-google-map" data-map-lat="{{ $property->latitude }}"
                                ...
                                data-map-title="Brooklyn, New York, United Kingdom" data-map-zoom="15"
                                data-markers='{
                    ...
                    <div class="author-widget sidebar-widget">
                        <div class="author-box">
                            ...
                            @if ($property->owner_id == null)
                                ...
                                <div class="inner">
                                    ...
                                    @else
                                        <span class="text-danger">You need to Login first</span>
                                    @endauth
                                ...
                                <div class="inner">
                                    ...
                                    @auth
                                        <div id="app">
                                            ...
                                            <send-message :recevierid="{{ $property->owner_id }}"
                        ...
                        <div class="form-inner">
                            ...
                            @auth
                                ...
                                <form action="{{ route('submit-tenant') }}" method="POST" class="needs-validation"
                                        novalidate>
                                        @csrf <!-- CSRF token for security -->

                                        <div class="form-group mb-3 hidden-form-element">
                                        ...
                                        <div class="form-group mb-3 hidden-form-element">
                                            ...
                                            <input type="text" class="form-control" id="property_price"
                                                name="property_price"
                                                value="{{ old('property_price', $property->rent_price) }}" required>
                                        </div>

                                        <div class="form-group mb-3 hidden-form-element">
                                            <label for="owner_name" class="form-label">Owner Name</label>
                                            <input type="text" class="form-control" id="owner_name" name="owner_name"
                                                value="{{ old('owner_name', $property->owner->name) }}" required>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 hidden-form-element">
                                            ...
                                            <input type="email" class="form-control" id="owner_email"
                                                name="owner_email"
                                                value="{{ old('owner_email', $property->owner->email) }}" required>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 hidden-form-element">
                                            ...
                                            <input type="email" class="form-control" id="tenant_email"
                                                name="tenant_email"
                                                value="{{ old('tenant_email', auth()->user()->email) }}" required>
                                        </div>
                                    ...
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
                                            ...
                                            @if ($item->owner_id == null)
                                                <figure class="author-thumb"><img
                                                        src="{{ url('upload/ariyan.jpg') }}" alt=""></figure>
                                                <h6>Admin </h6>
                                            @else
                                                <figure class="author-thumb"><img
                                                        src="{{ !empty($item->user->photo) ? url('upload/owner_images/' . $item->user->photo) : url('upload/no_image.jpg') }}"
                                                        alt=""></figure>
