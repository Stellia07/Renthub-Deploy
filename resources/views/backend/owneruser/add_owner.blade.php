...
<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<h6 class="card-title">Add Owner   </h6>

  <form id="myForm" method="POST" action="{{ route('store.owner') }}" class="forms-sample">
				@csrf
 ...
 <label for="exampleInputEmail1" class="form-label">Owner Address   </label>
   ...
   <div class="form-group mb-3">
 <label for="exampleInputEmail1" class="form-label">Owner Password   </label>
