...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: orange; font-size: 26px;"><strong>RentHub</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Renthub Head Office
               Email:support@renthub.com <br>
               Mob: 1245454545 <br>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
    <tr>
        ...
        <td>
          <p class="font">
            <h3><span style="color: orange;">Invoice:</span> #{{ $packagehistory->invoice }}</h3>
