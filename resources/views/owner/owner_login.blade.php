    ...
    <div class="auto-container">
        <div class="row clearfix">
            <div class="col-xl-8 col-lg-12 col-md-12 offset-xl-2 big-column">
                <div class="sec-title">
                    <h2>Sign In and Sign Up With RentHub</h2>
                </div>
                <div class="tabs-box">
                    <div class="tab-btn-box">
                        <ul class="tab-btns tab-buttons centred clearfix">
                            <li class="tab-btn active-btn" data-tab="#tab-1">Owner Login</li>
                            <li class="tab-btn" data-tab="#tab-2">Owner Register</li>
                        </ul>
                    </div>
                    <div class="tabs-content">
                        ...
                        <div class="tab" id="tab-2">
                            <div class="inner-box">
                                ...
                                <form action="{{ route('owner.register') }}" method="post" class="default-form">
                                @csrf
                                ...
                                <div class="othre-text">
                                    <p>Already Have an Account? <a href="signup.html">Login Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
