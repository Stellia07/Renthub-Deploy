...
<div class="page-content">
    ...
    <div class="card-body">
        <h6 class="card-title">Edit Property </h6>
            ...
            <form method="post" action="{{ route('owner.update.property') }}" id="myForm" enctype="multipart/form-data">
                @csrf
 ...
 <button type="submit" class="btn btn-primary">Save Changes </button>
    ...
    <div class="page-content" style="margin-top: -35px;" > 
        ...
        <div class="card-body">
            <h6 class="card-title">Edit Main Thumbnail Image </h6>
                ...
                <form method="post" action="{{ route('owner.update.property.thumbnail') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
   ...
   <!--  /// Property Multi Image Update //// -->
           ...
           <div class="page-content" style="margin-top: -35px;" > 
            ...
            <form method="post" action="{{ route('owner.update.property.multiimage') }}" id="myForm" enctype="multipart/form-data">
                        @csrf
        ...
        <table class="table table-striped">
            ...
            <a href="{{ route('owner.property.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete">Delete </a>
                    </td>
                </tr>
                @endforeach
                ...
                <form method="post" action="{{ route('owner.store.new.multiimage') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
 ...
 <!--  /// End Property Multi Image Update //// -->
     ...
     <!--  /// Facility Update //// -->
      ...
      <div class="page-content" style="margin-top: -35px;" > 
          ...
          <form method="post" action="{{ route('owner.update.property.facilities') }}" id="myForm" enctype="multipart/form-data">
                      @csrf
  ...
  <button type="submit" class="btn btn-primary">Save Changes </button>
     ...
     <!--  /// Risk Update //// -->
      ...
      <div class="page-content" style="margin-top: -35px;" > 
          ...
          <form method="post" action="{{ route('owner.update.property.risks') }}" id="myForm" enctype="multipart/form-data">
                      @csrf
