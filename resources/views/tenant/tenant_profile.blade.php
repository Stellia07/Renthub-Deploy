            ...
            <div class="card rounded">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div>
                    <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/owner_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
              ...
              <div class="card-body">
        				...
        				<h6 class="card-title">Update Owner Information</h6>

        				<form method="POST" action="{{ route('owner.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
        					@csrf
        					...
        					<div class="mb-3">
        						...
        						<img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/owner_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
        					</div>
